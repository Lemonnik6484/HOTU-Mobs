...
public class CursedHuman extends Animal implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public CursedHuman(EntityType<? extends Animal> entityType, Level level) {
    ...
    private PlayState attackPredicate(AnimationState<CursedHuman> AnimationState) {
    ...
    private PlayState predicate(AnimationState<CursedHuman> AnimationState) {
