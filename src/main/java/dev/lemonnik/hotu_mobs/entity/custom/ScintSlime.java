...
public class ScintSlime extends Animal implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public ScintSlime(EntityType<? extends Animal> entityType, Level level) {
    ...
    private PlayState attackPredicate(AnimationState<ScintSlime> AnimationState) {
    ...
    private PlayState predicate(AnimationState<ScintSlime> AnimationState) {
