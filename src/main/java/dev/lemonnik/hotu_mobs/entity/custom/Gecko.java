...
public class Gecko extends Animal implements GeoEntity {
    ...
    public Gecko(EntityType<? extends Animal> entityType, Level level) {
    ...
    private PlayState attackPredicate(AnimationState<Gecko> AnimationState) {
    ...
    private PlayState predicate(AnimationState<Gecko> AnimationState) {
