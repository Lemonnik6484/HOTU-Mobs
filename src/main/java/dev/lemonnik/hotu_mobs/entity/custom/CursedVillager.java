...
public class CursedVillager extends Animal implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public CursedVillager(EntityType<? extends Animal> entityType, Level level) {
    ...
    private PlayState attackPredicate(AnimationState<CursedVillager> AnimationState) {
    ...
    private PlayState predicate(AnimationState<CursedVillager> AnimationState) {
