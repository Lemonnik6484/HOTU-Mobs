...
public class ForestSpirit extends Animal implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public ForestSpirit(EntityType<? extends Animal> entityType, Level level) {
    ...
    private PlayState attackPredicate(AnimationState<ForestSpirit> AnimationState) {
    ...
    private PlayState predicate(AnimationState<ForestSpirit> AnimationState) {
