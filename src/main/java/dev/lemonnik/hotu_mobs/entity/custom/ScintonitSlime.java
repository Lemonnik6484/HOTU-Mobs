...
public class ScintonitSlime extends Animal implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public ScintonitSlime(EntityType<? extends Animal> entityType, Level level) {
    ...
    private PlayState attackPredicate(AnimationState<ScintonitSlime> AnimationState) {
    ...
    private PlayState predicate(AnimationState<ScintonitSlime> AnimationState) {
